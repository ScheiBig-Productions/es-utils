...
interface MinByFn {
     ...
     */
    <T>(this: Iter<T>, selector: (value: T) => number): T | undefined;
    /**
     * Finds the minimum element based on a provided selector function.
     * Returns `undefined` if the iterator is empty.
     *
     ...
     * or `undefined` if this iterator is empty.
     */
    <T>(this: Iter<T>, selector: (value: T) => Date): T | undefined;
    /**
     * Finds the minimum element based on a provided selector function.
     * Returns `undefined` if the iterator is empty.
     *
     ...
     * or `undefined` if this iterator is empty.
     */
    <T>(this: Iter<T>, selector: (value: T) => string, config?: IntlCollatorProps): T | undefined;
}
interface MaxByFn {
    /**
...
interface ReduceFn {
     ...
     */
    <T>(this: Iter<T>, reducer: (acc: T, value: T) => T): T;
    /**
     ...
     * @returns The reduced value.
     */
    <T, U>(this: Iter<T>, reducer: (acc: U, value: T) => U, initial: U): U;
}
interface RangeFn {
    /**
     ...
     */
    (start: number, end: number): Iter<number>;
    /**
     ...
     */
    (start: number, end: number, step: number): Iter<number>;
}
/**
