...
interface AlsoFn {
     ...
     */
    <T, R>(val: T | null | undefined, mapping: (it: T) => R, passthrough?: "nullish"): R | null | undefined;
    /**
     * Applies mapping to value, if it is defined, otherwise returns
     * the value itself.
     *
     ...
     */
    <T, R>(val: T | null, mapping: (it: T) => R, passthrough: "null"): R | null;
    /**
     * Applies mapping to value, if it is defined, otherwise returns
     * the value itself.
     *
     ...
     */
    <T, R>(val: T | undefined, mapping: (it: T) => R, passthrough: "undef"): R | undefined;
}
declare global {
