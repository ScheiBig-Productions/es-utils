...
export declare namespace Enum {
    ...
    const Symbol_enumValues: unique symbol;
     ...
     * ```
     */
    export const create: <const T extends Entries>(...rawValues: T) => ObjectEnum<T>;
    /**
     ...
     * //   ^? => "Audi" | "Peugeot" | "Toyota"
     */
    export type type<E extends ObjectEnum<any>> = E[typeof Symbol_enumValues][number];
    /**
     ...
     * //    ^? => ("Audi" | "Peugeot" | "Toyota")[]
     */
    export const values: <const T extends Entries>(enumObj: ObjectEnum<T>) => ReadonlyArray<ExtractValues<T>[number]>;
    export {};
}
